    ...
    private function getDefaultSections(): array
    {
        return [
            'hero' => [
                ...
                'highlight_text' => 'Zerp',
                'image' => 'packages/local/LandingPage/src/Resources/assets/img/hero.png'
            ],
            'header' => [
                'variant' => 'header1',
                'company_name' => 'Zerp',
            ...
            'modules' => [
                ...
                'modules' => [
                    [
                        ...
                        'image' => 'packages/local/LandingPage/src/Resources/assets/img/hrm.png'
                    ],
                    [
                        'key' => 'account',
                        ...
                        'image' => 'packages/local/LandingPage/src/Resources/assets/img/accounting.png'
                    ],
                    [
                        'key' => 'taskly',
                        ...
                        'image' => 'packages/local/LandingPage/src/Resources/assets/img/project.png'
                    ],
                    [
                        'key' => 'crm',
                        'label' => 'CRM & Sales',
                        ...
                        'image' => 'packages/local/LandingPage/src/Resources/assets/img/crm.png'
                    ],
                    [
                        'key' => 'pos',
                        'label' => 'Point of Sale',
                        ...
                        'image' => 'packages/local/LandingPage/src/Resources/assets/img/pos.png'
                    ]
                ]
            ],
            'benefits' => [
